...
This is the endopoint or entrypoint to create the repository, we pass it a this *body* either from a tool such as postman or from swagger itself

[source,sh]
----
localhost:9090/api/v1/gitlab-repository
----

image:/image-1/images/using-this-server-from-docker.png[width="100%"]
